...
export default function ApplyJobButton(props: ApplyJobButtonProps) {
  ...
  return (
    <button
      ...
      onClick={onClick}
      disabled={disabled}
      className="h-[3rem] w-[14.5rem] text-[1rem] border border-solid border-primary rounded-[6.25rem] py-[0] px-[1rem] font-[700] text-tertiary capitalize bg-button-green hover:bg-hover-green disabled:text-disabled-grey"
    >
      {text}
    </button>
  );
