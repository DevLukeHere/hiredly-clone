  ...
  return (
    <main className="grid grid-cols-1 justify-items-center tablet:grid-cols-4 tablet:p-6 laptop:grid-cols-6 laptop:p-8 gap-2 min-h-screen p-4">
      <div className="relative">
        <Image className="rounded-lg" alt="Hiro Luke image" src={"https://assets.wobbjobs.com/images/about_us/hiroes-2022/luke.jpg"} priority width={220} height={220} loading="eager" quality={10} />
